...
- [x] 1.2 Verify the topbar renders edge-to-edge above the sidebar and content area at all viewport widths
...
- [x] 2.5 Verify the main content area (`flex-1`) expands to fill freed space when the sidebar collapses
...
- [x] 6.1 Start the frontend dev server and verify the topbar spans full width above the sidebar on the dashboard page
- [x] 6.2 Toggle the sidebar collapse and confirm labels hide, icons remain, and content area reflows
- [x] 6.3 Confirm the user display name appears in title case in the topbar for a test account
- [x] 6.4 Click the user name, confirm the dropdown opens with Settings and Logout items, and confirm outside-click closes it
- [x] 6.5 Click Settings and confirm navigation to the settings route
- [x] 6.6 Click Logout and confirm session is cleared and redirect to login
- [x] 6.7 Confirm Settings no longer appears in the sidebar nav list
